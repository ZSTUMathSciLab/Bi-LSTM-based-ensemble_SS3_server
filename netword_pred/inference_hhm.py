...
def network(inputs,seq_lens,max_seq_len,rnn_size,layers_size,keep_prob_ph):
    ...
    with tf.variable_scope('encoder_hhm1'):
...
def inference_hhm(input_data_hhm,seq_lens,max_seq_len,rnn_size,layers_size,keep_prob_ph):

    with tf.name_scope('inference_hhm'):
        out = network(input_data_hhm,seq_lens,max_seq_len,rnn_size,layers_size,keep_prob_ph)
